$PBExportHeader$n_cst_toolbarstrip_gradient.sru
forward
...
l_Gradient[1].upperleft = UnitsToPixels(X1, XUnitsToPixels!)+1
l_Gradient[1].lowerright = UnitsToPixels(Y1, YUnitsToPixels!)
l_Gradient[2].upperleft = UnitsToPixels(X2, XUnitsToPixels!)+1
l_Gradient[2].lowerright = UnitsToPixels(Y2, YUnitsToPixels!)
